...
backtop.directive('backTop', [function() {
  return {
    ...
    transclude: true,
    replace: true,
    template: '<div id="backtop" class="{{theme}} {{position}}"><button class="{{buttonClass}}"><div ng-transclude></div>{{text}}<i class="angle double up icon"></i></button></div>',
    scope: {
      text: "@buttonText",
      speed: "@scrollSpeed",
      theme: "@buttonTheme",
    ...
    link: function(scope, element) {
      ...
      scope.buttonClass = scope.theme == 'ifsa' ? 'ui labeled icon tiny button ifsa-btn' : null;
