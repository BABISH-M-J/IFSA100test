/**
 * Student Portal Recommendation Rich Text Parser Service
 * @file Student Portal Recommendation Rich Text Parser Service
 * @copyright 2019 Institute for Study Abroad
 * @author Brock Barlow <bbarlow@ifsabutler.org> 
 * @version 2.0
 */
angular.module('app.services')
.service('richTextParseService', function() {
	var self = this;
	var wndw = window;
    var defaultStyles = {
      b: {bold:true},
            ...
            var computeStyle = function(style) {
              ...
              styleDefs.forEach(function(styleDef) {
                ...
                switch (key) {
                  ...
                  case "font-size": {
                    ret.push({key: "fontSize", value:parseInt(value)});
                    break;
                  }
                  default: {
